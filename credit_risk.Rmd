---
title: "Credit Risk Modelling [EDA & Classification]"
author: "IonasKel"
...
loan = read_csv('D:/Desktop HDD/Datasets/loan.csv' , na = '')
...
table(Predictions = preds.for.30 , Actual = testset$loan_outcome)
```
```{r}
rm(preds.for.30)
...
A logistic regression model was used to predict the loan status. Different cut off's were used to decide if the loan should be granted or not. Cut off of 30% gave a good accuracy of 78.8%. The decision to set a cut off is arbitrary and higher levels of threshold increases the risk. The Area Under Curve also gives a measure of accuracy, which came out to be 69.5%.
